;(function (global) {
  ...
  const EXPENSE_TO_BLOCK = {
    ...
    'ФОТ_1':                              'production',  // агрегатная строка
    ...
    'Транспортные расходы':               'logistics',  // агрегатная строка
    'Транспортные расходы_1':             'logistics',  // агрегатная строка
    'Ремонт':                             'logistics',
    ...
    // МАРКЕТИНГ (17.3%)
    'Маркетинг_1':                        'marketing',  // агрегатная строка
  ...
  function getCostTree(dds, year) {
    ...
    const SUB_CATEGORY_MAP = {
      'ФОТ оклад ЦЕХ': 'ФОТ цех', 'ФОТ_1': 'ФОТ цех', 'Аванс': 'ФОТ цех',
      ...
      'Ремонт двигителя и коробки': 'Транспорт ТО', 'Транспортные расходы': 'Транспорт ТО',
      'Транспортные расходы_1': 'Транспорт ТО', 'Ремонт': 'Транспорт ТО',
      ...
      'Маркетинг_1': 'Платная реклама', 'Покупка рекламы Google': 'Платная реклама',
