;(function (global) {
  ...
  const INCOME_2025_MONTHLY = {
    ...
    // topUp = пополнения собственника + кредитные поступления (аналитика, уже включены в services)
    // Сен: 600 000 ₸ (кредит Kaspi GoldPay, 10.09.2025)
    // Окт: 8 535 309 ₸ (пополнение + кредит 3 000 000, 01.10.2025 — уже учтено)
    topUp:      [0, 0, 0, 0, 0, 0, 0, 0, 600000, 8535309, 0, 0]
  }
  ...
  const LOAN_REPAYMENTS_2025 = {
    ...
    monthly: [0, 0, 0, 0, 0, 0, 0, 0, 330000, 364605, 364605, 364605],
    total: 1_423_815  // 330 000 + 364 605 × 3
  }
